...
const heightMultipliers = {
  ...
  "203cm": { JS:1,   JR:0.95, OD:0.95, HA:1, DR:0.95,   PA:1,   IS:1.05, ID:1.05, RB:1.05, SB:1.05 },
  "206cm": { JS:1,   JR:0.9,  OD:0.9,  HA:1, DR:0.95,   PA:1,   IS:1.1,  ID:1.1,  RB:1.1,  SB:1.1 },
  "208cm": { JS:1,   JR:0.85, OD:0.85, HA:1, DR:0.95,   PA:1,   IS:1.15, ID:1.15, RB:1.15, SB:1.15 },
  "211cm": { JS:1,   JR:0.8,  OD:0.8,  HA:1, DR:0.95,   PA:1,   IS:1.2,  ID:1.2,  RB:1.2,  SB:1.2 },
  "213cm": { JS:1,   JR:0.75, OD:0.75, HA:1, DR:0.95,   PA:1,   IS:1.25, ID:1.25, RB:1.25, SB:1.25 },
  "216cm": { JS:1,   JR:0.7,  OD:0.7,  HA:1, DR:0.95,   PA:1,   IS:1.3,  ID:1.3,  RB:1.3,  SB:1.3 },
  "218cm": { JS:1,   JR:0.65, OD:0.65, HA:1, DR:0.95,   PA:1,   IS:1.35, ID:1.35, RB:1.35, SB:1.35 },
  "221cm": { JS:1,   JR:0.6,  OD:0.6,  HA:1, DR:0.95,   PA:1,   IS:1.4,  ID:1.4,  RB:1.4,  SB:1.4 },
  "224cm": { JS:1,   JR:0.55, OD:0.55, HA:1, DR:0.95,   PA:1,   IS:1.45, ID:1.45, RB:1.45, SB:1.45 },
  "226cm": { JS:1,   JR:0.5,  OD:0.5,  HA:1, DR:0.95,   PA:1,   IS:1.5,  ID:1.5,  RB:1.5,  SB:1.5 },
  "229cm": { JS:1,   JR:0.45, OD:0.45, HA:1, DR:0.95,   PA:1,   IS:1.55, ID:1.55, RB:1.55, SB:1.55 }
};
