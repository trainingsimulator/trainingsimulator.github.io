...
const heightMultipliers = {
  "175cm": { JS:1,   JR:1.5,  OD:1.45,  HA:1, DR:0.97,   PA:1,   IS:0.65,  ID:0.5,  RB:0.5,  SB:0.5 },
  "178cm": { JS:1,   JR:1.45, OD:1.4, HA:1, DR:0.97,   PA:1,   IS:0.7, ID:0.55, RB:0.55, SB:0.55 },
  "180cm": { JS:1,   JR:1.4,  OD:1.35,  HA:1, DR:0.97,   PA:1,   IS:0.75,  ID:0.6,  RB:0.6,  SB:0.6 },
  "183cm": { JS:1,   JR:1.35, OD:1.3, HA:1, DR:0.97,   PA:1,   IS:0.78, ID:0.65, RB:0.65, SB:0.65 },
  "185cm": { JS:1,   JR:1.3,  OD:1.25,  HA:1, DR:0.97,   PA:1,   IS:0.83,  ID:0.7,  RB:0.7,  SB:0.7 },
  "188cm": { JS:1,   JR:1.25, OD:1.2, HA:1, DR:0.97,   PA:1,   IS:0.85, ID:0.75, RB:0.75, SB:0.75 },
  "190cm": { JS:1,   JR:1.2,  OD:1.15,  HA:1, DR:0.97,   PA:1,   IS:0.88,  ID:0.8,  RB:0.8,  SB:0.8 },
  "193cm": { JS:1,   JR:1.15, OD:1.1, HA:1, DR:0.97,   PA:1,   IS:0.93, ID:0.85, RB:0.85, SB:0.85 },
  "196cm": { JS:1,   JR:1.1,  OD:1.05,  HA:1, DR:0.97,   PA:1,   IS:0.95,  ID:0.9,  RB:0.9,  SB:0.9 },
  "198cm": { JS:1,   JR:1.05, OD:1, HA:1, DR:0.97,   PA:1,   IS:0.97, ID:0.95, RB:0.95, SB:0.95 },
  "201cm": { JS:1,   JR:1,    OD:0.95,    HA:1, DR:0.97,   PA:1,   IS:1.05,    ID:1,    RB:1,    SB:1   },
  "203cm": { JS:1,   JR:0.95, OD:0.9, HA:1, DR:0.97,   PA:1.05,   IS:1.1, ID:1.05, RB:1.05, SB:1.05 },
  "206cm": { JS:1,   JR:0.9,  OD:0.85,  HA:1, DR:0.97,   PA:1.1,   IS:1.15,  ID:1.1,  RB:1.1,  SB:1.1 },
  "208cm": { JS:1,   JR:0.85, OD:0.8, HA:1, DR:0.97,   PA:1.15,   IS:1.2, ID:1.15, RB:1.15, SB:1.15 },
  "211cm": { JS:1,   JR:0.8,  OD:0.75,  HA:1, DR:0.97,   PA:1.2,   IS:1.25,  ID:1.2,  RB:1.2,  SB:1.2 },
  "213cm": { JS:1,   JR:0.75, OD:0.7, HA:1, DR:0.97,   PA:1.25,   IS:1.3, ID:1.25, RB:1.25, SB:1.25 },
  "216cm": { JS:1,   JR:0.7,  OD:0.65,  HA:1, DR:0.97,   PA:1.3,   IS:1.35,  ID:1.3,  RB:1.3,  SB:1.3 },
  "218cm": { JS:1,   JR:0.65, OD:0.6, HA:1, DR:0.97,   PA:1.35,   IS:1.4, ID:1.35, RB:1.35, SB:1.35 },
  "221cm": { JS:1,   JR:0.6,  OD:0.55,  HA:1, DR:0.97,   PA:1.4,   IS:1.45,  ID:1.4,  RB:1.4,  SB:1.4 },
  "224cm": { JS:1,   JR:0.55, OD:0.5, HA:1, DR:0.97,   PA:1.45,   IS:1.5, ID:1.45, RB:1.45, SB:1.45 },
  "226cm": { JS:1,   JR:0.5,  OD:0.45,  HA:1, DR:0.97,   PA:1.5,   IS:1.55,  ID:1.5,  RB:1.5,  SB:1.5 },
  "229cm": { JS:1,   JR:0.45, OD:0.4, HA:1, DR:0.97,   PA:1.5,   IS:1.6, ID:1.55, RB:1.55, SB:1.55 }
};
...
function simulateTraining() {
  ...
  for (let s = 1; s <= seasonCount; s++) {
    ...
    for (let st of relevantStats) {
     ...
     const decayFactor = Math.pow(0.95, playerStats[st] - flatAverage);
