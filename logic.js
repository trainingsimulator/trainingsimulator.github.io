...
const elasticEffects = {
  'JS->DR': 0.0211, 'JR->OD': 0.0371, 'OD->HA': 0.0452,
...
const heightMultipliers = {
  "175cm": { JS:1,   JR:1.5,  OD:1.5,  HA:1, DR:0.97,   PA:1,   IS:0.65,  ID:0.5,  RB:0.5,  SB:0.5 },
  "178cm": { JS:1,   JR:1.45, OD:1.45, HA:1, DR:0.97,   PA:1,   IS:0.7, ID:0.55, RB:0.55, SB:0.55 },
  "180cm": { JS:1,   JR:1.4,  OD:1.4,  HA:1, DR:0.97,   PA:1,   IS:0.75,  ID:0.6,  RB:0.6,  SB:0.6 },
  "183cm": { JS:1,   JR:1.35, OD:1.35, HA:1, DR:0.97,   PA:1,   IS:0.78, ID:0.65, RB:0.65, SB:0.65 },
  "185cm": { JS:1,   JR:1.3,  OD:1.3,  HA:1, DR:0.97,   PA:1,   IS:0.83,  ID:0.7,  RB:0.7,  SB:0.7 },
  "188cm": { JS:1,   JR:1.25, OD:1.25, HA:1, DR:0.97,   PA:1,   IS:0.85, ID:0.75, RB:0.75, SB:0.75 },
  "190cm": { JS:1,   JR:1.2,  OD:1.2,  HA:1, DR:0.97,   PA:1,   IS:0.88,  ID:0.8,  RB:0.8,  SB:0.8 },
  "193cm": { JS:1,   JR:1.15, OD:1.15, HA:1, DR:0.97,   PA:1,   IS:0.93, ID:0.85, RB:0.85, SB:0.85 },
  "196cm": { JS:1,   JR:1.1,  OD:1.1,  HA:1, DR:0.97,   PA:1,   IS:0.95,  ID:0.9,  RB:0.9,  SB:0.9 },
  "198cm": { JS:1,   JR:1.05, OD:1.05, HA:1, DR:0.97,   PA:1,   IS:0.97, ID:0.95, RB:0.95, SB:0.95 },
  "201cm": { JS:1,   JR:1,    OD:1,    HA:1, DR:0.97,   PA:1,   IS:1.05,    ID:1,    RB:1,    SB:1   },
  "203cm": { JS:1,   JR:0.95, OD:0.95, HA:1, DR:0.97,   PA:1.05,   IS:1.1, ID:1.05, RB:1.05, SB:1.05 },
  "206cm": { JS:1,   JR:0.9,  OD:0.9,  HA:1, DR:0.97,   PA:1.1,   IS:1.15,  ID:1.1,  RB:1.1,  SB:1.1 },
  "208cm": { JS:1,   JR:0.85, OD:0.85, HA:1, DR:0.97,   PA:1.15,   IS:1.2, ID:1.15, RB:1.15, SB:1.15 },
